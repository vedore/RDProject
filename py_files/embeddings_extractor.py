...
def get_embedding_file(owl_path, npy_file_name):
    ...
    np.save(npy_file_name, get_embedding_from_owl_file(owl_path))


get_embedding_file("anatomy-dataset/anatomy-dataset/human.owl", "human_embeddings.npy")
get_embedding_file("anatomy-dataset/anatomy-dataset/mouse.owl", "mouse_embeddings.npy")
